            ...
            <div className='container relative' ref={parallaxRef}>
                ...
                mx-auto text-center mb-[4rem] md:mb-20 lg:mb:[6rem]'>
                    <h1 className='h1 mb-6'>
                        From <span className='inline-block relative'>
                            Brainwave{" "}
                            <img
                                src={curve}
                                ...
                                alt='curve'
                            />
                        </span> to Bytes: The New Era of Communication

                    </h1>
                    <p className='body-1 max-w-3xl mx-auto mb-6 text-n-2 lg:mb-8'>
                        Transform your workflow with Brainwave’s AI capabilities. Boost your productivity with Brainwave, the intelligent AI chat app.
                            ...
                            <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]'>
                                ...
                                <ScrollParallax isAbsolutelyPositioned>
                                    <ul className='hidden absolute -left-[5.5rem] bottom-[7.5rem] px-1 py-1
                                     bg-n-9/40 background-blur border border-n-1/10 rounded-2xl xl:flex'>
                ...
                <CompanyLogo className="hidden relative z-20 mt-20 lg:block"/>
