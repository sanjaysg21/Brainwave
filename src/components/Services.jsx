...
import Generaing from './Generating';
        ...
        <Section id="how-to-use">
            <div className='container'>
             ...
             rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]'>
                        ...
                        <Generaing className="absolute left-4 right-4 bottom-4 border-n-1/10 border lg:left-1/2 lg-right-auto lg:bottom-8 lg:-translate-x-1/2" />
                    </div>
                    <div className='relative z-1 grid gap-5 lg:grid-cols-2'>
                        <div className='relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden'>
                            ...
                            <div className='absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-p from-n-8/0 to-n-8/90 lg:p-15 '>
